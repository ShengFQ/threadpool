...
public class TestPdfParse {
    ...
    private static String DOC1="/Users/sheng/schedule/target&plan&schedule&task/杭州煋辰数智科技[进行]/资金查控管理系统/1法律文书/呈请协助冻结财产报告书.pdf";
    ...
    public static void main(String[] args) throws  Exception{
        String formDocument= PDFParseUtils.getPdfTxtDocument(DOC1);
